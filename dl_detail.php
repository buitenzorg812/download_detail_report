...
<iframe name="reportView" id="reportView" src="<?php echo $iframeUrl; ?>" frameborder="0" style="width: 100%; height: 500px;"></iframe>
<?php
} else if (isset($_GET['startDate']) AND isset($_GET['untilDate'])) {
    ob_start();
    // create datagrid
